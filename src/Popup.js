...
//                                 reader.readAsDataURL(file);
//                                 reader.onload = function () {
//                                     onCreate(reader.result, title, price, description);
//                                 };
//                             } else {
//                                 onCreate(NoImg, title, price, description);
//                             }
//                         }}>
//                             <div style={Styles.container}>
//                                 <div style={Styles.imgDiv}>
...
//                                 <div>
//                                     <p>상품명</p>
//                                     <input type='text' name="title" style={Styles.inputBox} placeholder='ex)레고'/>
//                                     <p>가격</p>
//                                     <input type='text' name="price" style={Styles.inputBox} placeholder='숫자만 입력'/>
//                                 </div>
//                             </div>
